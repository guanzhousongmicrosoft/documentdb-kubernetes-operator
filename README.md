...
- **Karmada Demo**: [Demonstration of using Karmada for multi-cluster management as an alternative to Azure Fleet](documentdb-playground/karmada-demo/README.md)
